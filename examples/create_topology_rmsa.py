...
# topology = get_topology('./topologies/Telia_topology.txt', 'Telia', modulations, k_paths=k_paths)
# topology = get_topology('./topologies/Germany50.txt', 'Germany50', modulations, k_paths=k_paths)
topology = get_topology('./topologies/Coronet.txt', 'Coronet', modulations, k_paths=k_paths)
# with open(f'./topologies/nsfnet_chen_eon_{k_paths}-paths.h5', 'wb') as f:
#     pickle.dump(topology, f)

with open(f'./topologies/Coronet_{k_paths}-paths.h5', 'wb') as f:
    pickle.dump(topology, f)
